class Game {
	...
	keyDown(key) {
		if (!this.gameplayStarted) this.level.start();
	...
	addGameObject(gameObject) {
		if (gameObject instanceof GameObject) this.gameObjects.push(gameObject);
	}
	...
	startLoop() {
		...
		if (this.gameplayStarted && this.isActive) this.level.start();
	}
